...
// Re-exported so the many call sites that reach for it through this module
// keep working; it lives one level up because the external-location resolver
// needs it too, and that is shared with the server.
