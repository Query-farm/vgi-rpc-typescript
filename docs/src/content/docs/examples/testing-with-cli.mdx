...
The Python [vgi-rpc CLI](https://github.com/Query-farm/vgi-rpc-python) is the primary tool for testing vgi-rpc servers. It can discover methods, call them, and display results in various formats.
...
This calls `vgi_rpc.Reflection.v1` — `list_protocols`, then `describe` — and displays all available methods, their parameters, result schemas, and documentation.
