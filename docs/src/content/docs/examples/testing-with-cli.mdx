...
The Python [vgi-rpc CLI](https://github.com/rustyconover/vgi-rpc) is the primary tool for testing vgi-rpc-typescript servers. It can discover methods, call them, and display results in various formats.
