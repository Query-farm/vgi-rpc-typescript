...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      plugins: [
        // Generate the API reference from JSDoc + TS types in src/index.ts.
        // The public surface is whatever index.ts re-exports, so pointing at
        // the single entry point naturally scopes docs to the public API —
        // internal modules (arrow backends, constants internals) are excluded.
        starlightTypeDoc({
      ...
      sidebar: [
        ...
        // Auto-generated by starlight-typedoc from the public API surface.
        typeDocSidebarGroup,
      ],
    }),
  ],
